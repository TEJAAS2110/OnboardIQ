...
class DocumentProcessor:
    ...
    def _process_pdf(self, path: Path) -> str:
        ...
        try:
            ...
            logger.warning("Error processing PDF %s: %s", path, e)
            return ""
    ...
    def _process_docx(self, path: Path) -> str:
        ...
        try:
            ...
            logger.warning("Error processing DOCX %s: %s", path, e)
            return ""
    ...
    def _process_text(self, path: Path) -> str:
        ...
        try:
            ...
            logger.warning("Error processing text file %s: %s", path, e)
            return ""
    ...
    def _process_html(self, path: Path) -> str:
        ...
        try:
            ...
            logger.warning("Error processing HTML %s: %s", path, e)
            return ""
