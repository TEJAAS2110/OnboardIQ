...
class IngestionPipeline:
    ...
    def __init__(self):
        ...
        logger.info("Initialized ChromaDB collection: %s", settings.COLLECTION_NAME)
        logger.info("Current document count: %d", self.collection.count())
    ...
    def _store_chunks(self, chunks: List[Dict], embeddings: List[List[float]], doc_data: Dict):
        ...
        logger.info("Stored %d chunks in ChromaDB", len(ids))
    ...
    def delete_document(self, file_name: str) -> bool:
        ...
        try:
            ...
            if results['ids']:
                ...
                logger.info("Deleted %d chunks from %s", len(results['ids']), file_name)
                return True
